    ...
    addPane: function () {
        ...
        for (var i = 0; i < colors.length; i++) {
            ...
            var B = new bkElement("DIV").setStyle({
              ...
              .addEvent("mouseover", this.on.closure(this, C))
              .addEvent("mouseout", this.off.closure(this, C, I))
              .appendTo(C);
